...
function build(appDirectory, jar, appId, profile, formDataExtra) {
  ...
  if (typeof profile === 'undefined') {
    ...
    promise = Security.getProfile(appId, jar, profile);
  }
  ...
  promise
    ...
    .then(function() {
      ...
      if (typeof profile !== 'undefined') {
        _.extend(formData, { security_profile_tag: profile });
      }
