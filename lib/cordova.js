...
Cordova.Lib = require('ionic-cordova-lib');
Cordova.logger = logging.defaultLogger;
...
Cordova.setupLiveReload = function() {
  ...
  Cordova.logger.info('Setup Live Reload'.green.bold);
...
Cordova.addPlatform = function addPlatform(projectRoot, platform, savePlatform) {
  Cordova.logger.debug('Cordova.addPlatform: ', projectRoot, platform, savePlatform);
  // var opts = { 
  ...
  .then(function() {
    ...
    Cordova.logger.info(('Added ' + platform + ' platform').green);
    process.env.PWD = originalPwd;
    if (savePlatform) {
      Cordova.logger.debug('Cordova.addPlatform call specified to save platform. Saving to package.json now.');
...
Cordova.addPlugin = function addPlugin(projectRoot, pluginId, pluginVariables, savePlugin) {
  Cordova.logger.debug('Cordova.addPlugin: projectRoot', projectRoot, 'pluginId', pluginId, 'pluginVariables', pluginVariables, 'savePlugin', savePlugin);
  var originalPwd = process.env.PWD;
  process.env.PWD = projectRoot;
