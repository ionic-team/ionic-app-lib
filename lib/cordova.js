...
Cordova.addPlugin = function addPlugin(projectRoot, pluginId) {
  console.log('Cordova.addPlugin', projectRoot, pluginId);
  var options = {
  ...
  .then(function() {
    console.log('Plugin add:', pluginId);
    process.env.PWD = originalPwd;
  })
  .catch(function(error) {
    console.log('ionic-app-lib error', error);
    throw error;
  });
};

Cordova.removePlugin = function removePlugin(projectRoot, pluginId) {
  console.log('Cordova.removePlugin', projectRoot, pluginId);
  var options = {
