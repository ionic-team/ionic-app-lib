...
Transpile.prepareFonts = function prepareFonts(appDirectory, fontsOutputPath) {
  ...
  var tffFontPath = path.join(appDirectory, 'node_modules', 'ionic-framework', 'dist', 'fonts', '*.ttf');
  var woffFontPath = path.join(appDirectory, 'node_modules', 'ionic-framework', 'dist', 'fonts', '*.woff');
