...
Project.V2_PROJECT_FILE_DIR = '.ionic';
Project.V2_PROJECT_FILE = 'project.js';
Project.V2_CONFIG_FILE = 'ionic.config.js';
Project.V2_PROJECT_DEFAULT = {
...
Project.createV2 = function createV2(appDirectory, name){
...
Project.save = function save(appDirectory, data, isV2) {
  if (!data) {
    console.trace();
    console.error('This should never happen!');
  }

  // data = { sassEntryPath: '/www/app/scss' }
  // save as = module.exports = {
  // data
  //            }
  try {
    var fileName = isV2 ? Project.V2_PROJECT_FILE : Project.PROJECT_FILE;
