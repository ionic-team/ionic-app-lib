...
function addProfile(appId, jar, name) {
  var q = Q.defer();
...
function listProfiles(appId, jar) {
  var q = Q.defer();
...
function getProfile(appId, jar, tag) {
  var q = Q.defer();
...
function addAndroidCredentials(appId, jar, profileTag, keystoreFileStream,
...
function addIOSCredentials(appId, jar, profileTag, certificateFileStream,
...
module.exports = {
  ...
  addAndroidCredentials: addAndroidCredentials,
  addIOSCredentials: addIOSCredentials
};
