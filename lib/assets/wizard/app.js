angular.module('app', ['ngAnimate', 'ngSanitize', 'ionicate'])
...
.controller('LaunchCtrl', ['$scope', '$http', function($scope, $http) {
  ...
  $scope.surveyQuestions = {
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { title: 'I\'m just kicking the tires', tag: 'appfornothing', value: 'for-nothing' },
        ],
        allowOther: true
      }
    ],
    ...
    contact: {
      ifHasValue: 'whatyoucreate.appforcompany'
    }
  };
