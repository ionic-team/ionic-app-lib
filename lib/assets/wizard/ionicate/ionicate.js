                ...
                '<div class="ionicate-content">' +
                  '<div class="ionicate-done" ng-if="!question">' +
                    ...
                    '<div class="ionicate-contact" ng-if="showContact">' +
                      'Are you open to having us contact you about your response?' +
                      '<div class="ionicate-contact-buttons">' +
                        '<a class="ionicate-button" ng-click="setCanContact(true)">Yes</a>' +
                        '<a class="ionicate-button" ng-click="setCanContact(false)">No</a>' +
                      '</div>' +
                    '</div>' +
                  '</div>' +
                  ...
                  '</ul>' +
                '</div>' +
                '<div class="ionicate-submit-button"><a class="ionicate-button" ng-click="submit()">Submit</a></div>' +
              '</div>',
    link: function($scope) {
      $scope.results = [];
      ...
      $scope.shouldShowContact = function(results) {
        var path = $scope.questions.contact && $scope.questions.contact.ifHasValue;
