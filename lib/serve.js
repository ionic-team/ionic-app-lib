...
Serve.loadSettings = function loadSettings(argv, project) {
  ...
  options.sassEntryPath = project.get('sassEntryPath') || '/www/app/scss';
  options.sassOutputPath = project.get('sassOutputPath') || '/www/build/css';
  options.sassIncludePaths = project.get('sassIncludePaths') || ['node_modules/ionic-framework/src/sass'];
