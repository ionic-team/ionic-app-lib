...
Serve.startServer = function startServer(options, app) {
  ...
  //TODO Adjust the document Root for local path
  // console.log('process.cwd', process.cwd());
  // console.log('options.appDirectory', options.appDirectory);
...
Serve.start = function start(options) {
  ...
  try {
    ...
    // console.log('Options from start:', options);
...
Serve.getAddress = function(options) {
  ...
  try {
    ...
    if (addresses.length > 0) {
      ...
      console.log('prompting for address');
