...
Start.printQuickHelp = function(options) {
  ...
  logging.logger.info('  ionic run ios[android,browser]');
  ...
  logging.logger.info('  http://ionic.io/enterprise');
  logging.logger.info('\nFor everything else, head over to the docs:'.bold);
  logging.logger.info('  http://ionicframework.com/docs/v2/');
};
